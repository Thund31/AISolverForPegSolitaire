...
int main(int argc, char *argv[]) {
	...
	if( ai_run ){ 
		...
		fprintf(filePtr, "STATS:");
		fprintf(filePtr, "\nExpanded nodes: %'d", expanded_nodes);
		fprintf(filePtr, "\nGenerated nodes: %'d", generated_nodes);
		fprintf(filePtr, "\nSolution Length: %d", solution_size);
		fprintf(filePtr, "\nNumber of Pegs Left: %d", num_pegs(&(solution[solution_size])));
		fprintf(filePtr, "\nExpanded/seconds: %d", (int)(expanded_nodes/cpu_time_used));
		fprintf(filePtr, "\nTime (seconds): %f", cpu_time_used);
